...
void set_overworld_theme(z2music::Song* theme) {
  ...
  theme->add_pattern({
      0x20,
      z2music::Pattern::parse_notes("d#4.4     a#3     d#4.2 f4.4    f#4.6     r.8            f4.2 d#4 c#4.8          r            d#4.4   a#3    d#4.2 c#4 a#3 c#4", 0),
      z2music::Pattern::parse_notes("r.4       a#4     g#4       a#4     c#5   a#4     g#4    a#4      f4      a#4    g#4   a#4    c#5     a#4    d#5       a#4",     0),
      z2music::Pattern::parse_notes("d#4.2 d#4 f#4 a#4 d#5   f#4 a#4 d#5 b3 b3 d#4 f#4 b4 d#4 f#4  b4  c#4 c#4 f4 g#4 b4 f4 g#4 b4 a#3 a#3 c#4 f4 a#4   c#4 f4 a#4",  0),
      z2music::Pattern::parse_notes("r.4       x.8               x.2 x.6       x          x.4      x.2"),
      });

  theme->add_pattern({
      0x20,
      z2music::Pattern::parse_notes("d#4.4     a#3     d#4.2 f4.4    f#4.6     r.8            f4.2 f#4 g#4.8          r            a#4.4   g#4    f#4     g#4.2 a#4", 0),
      z2music::Pattern::parse_notes("r.4       a#4     g#4       a#4     c#5   a#4     g#4    a#4      f4      a#4    g#4   a#4    c#5     a#4    d#5     f5",        0),
      z2music::Pattern::parse_notes("d#4.2 d#4 f#4 a#4 d#5   f#4 a#4 d#5 b3 b3 d#4 f#4 b4 d#4 f#4  b4  c#4 c#4 f4 g#4 b4 f4 g#4 b4 a#3 a#3 c#4 f4 a#4 c#4 f4 a#4",    0),
      z2music::Pattern::parse_notes("r.4       x.8               x.2 x.6       x          x.4      x.2"),
      });
  ...
  theme->add_pattern({
      0x20,
      z2music::Pattern::parse_notes("r.4       d#5     a#4.2 g#4 f#4 g#4 a#4.8         r.4    g#4.2 f#4 f4.8           r            d#4.4   a#3    d#4.2 f4  f#4 g#4", 0),
      z2music::Pattern::parse_notes("r.4       a#4     g#4       a#4     c#5   a#4     g#4    a#4       d#5     a#4    g#4   a#4    f#5     f5     d#5       c#5",     0),
      z2music::Pattern::parse_notes("d#4.2 d#4 f#4 a#4 d#5   f#4 a#4 d#5 b3 b3 d#4 f#4 b4 d#4 f#4   b4  c#4 c#4 f4 g#4 b4 f4 g#4 b4 a#3 a#3 c#4 f4 a#4   c#4 f4  a#4", 0),
      z2music::Pattern::parse_notes("r.4       x.8               x.2 x.6       x          x.4       x.2"),
      });
  ...
  theme->add_pattern({
      0x20,
      z2music::Pattern::parse_notes("a#4.4     d#5     a#4.2 g#4 a#4 g#4 f#4.8         r.4    d#4.2 f4 f#4.8          r            f4             c#4",            0),
      z2music::Pattern::parse_notes("r.4       a#4     g#4       a#4     c#5   a#4     g#4    a#4      d#5     a#4    g#4   a#4    f#5     f5     d#5     f5",     0),
      z2music::Pattern::parse_notes("d#4.2 d#4 f#4 a#4 d#5   f#4 a#4 d#5 b3 b3 d#4 f#4 b4 d#4 f#4   b4 c#4 c#4 f4 g#4 b4 f4 g#4 b4 a#3 a#3 c#4 f4 a#4 c#4 f4 a#4", 0),
      z2music::Pattern::parse_notes("r.4       x.8               x.2 x.6       x          x.4       x.2"),
      });
